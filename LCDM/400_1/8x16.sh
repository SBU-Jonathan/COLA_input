...
#SBATCH --output=/gpfs/projects/MirandaGroup/jonathan/cola_projects/5D_emulator1/slurm_files/out/run_%a.out
#SBATCH --error=/gpfs/projects/MirandaGroup/jonathan/cola_projects/5D_emulator1/slurm_files/err/run_%a.err
#SBATCH --partition=short-40core
#SBATCH -t 4:00:00

colasolver=/gpfs/projects/MirandaGroup/jonathan/FML/FML/COLASolver/nbody
param_file=/gpfs/projects/MirandaGroup/jonathan/cola_projects/5D_emulator1/lua_files/parameter_file${SLURM_ARRAY_TASK_ID}.lua
